...
bool print_usage() {
   ...
   cout << "decoding: ./train-hmmAligner 2 tParameters aParameters testFilename outputFilePathPrefix K" << endl;
}
...
int main(int argc, char **argv) {
    ...
    if (ParseParameters(argc, argv, \
                        ...
                        tParams, aParams, testFilename, mode, use_lattice, K)) {
        ...
        if (mode == 1) { 
            ...
            HmmAligner model(tParams, aParams, testFilename, K);
