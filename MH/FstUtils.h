...
class FstUtils {
 public:
    ...
    static int GetLongestPathLen(fst::VectorFst<fst::LogArc>& fst); 
    ...
    static void LoadLatticeFsts(vector<string>& lattice_paths, \
                                vector<vector<int> >& srcSents, \
                                vector<fst::VectorFst<fst::LogArc> >& lattice_fsts, \
                                VocabEncoder& vocabEncoder);

    static void LoadLatticeFst(const string lattice_path, \
                               vector<int>& srcSent, \
                               fst::VectorFst<fst::LogArc>& lattice_fst, \
                               VocabEncoder& vocabEncoder);
